...
import terra1 from '../assets/terra_1.png'
import terra2 from '../assets/terra_2.png'
import terra3 from '../assets/terra_3.png'
...
export const PARTNERS = {
    ...
    water: {
        ...
        name: '아쿠아',
        stages: [
            { name: '아쿠아', image: aqua1, minLevel: 1, maxLevel: 9 },
            { name: '아쿠아 가디언', image: aqua2, minLevel: 10, maxLevel: 19 },
            { name: '아쿠아 로드', image: aqua3, minLevel: 20, maxLevel: 999 }
        ],
        color: 'bg-blue-500',
    ...
    grass: {
        ...
        name: '테라',
        stages: [
            { name: '테라', image: terra1, minLevel: 1, maxLevel: 9 },
            { name: '테라 스피릿', image: terra2, minLevel: 10, maxLevel: 19 },
            { name: '테라 마스터', image: terra3, minLevel: 20, maxLevel: 999 }
        ],
        color: 'bg-green-500',
